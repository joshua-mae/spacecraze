...
struct AcknowledgementView: View {
    var body: some View {
        ScrollView {
            VStack(spacing: 10) {
                Section(header: Text("Overview").font(.title).fontWeight(.bold)) {
                ...
                Section(header: Text("Sources").font(.title).fontWeight(.bold)) {
                ...
                Section(header: Text("Closing").font(.title).fontWeight(.bold)) {
